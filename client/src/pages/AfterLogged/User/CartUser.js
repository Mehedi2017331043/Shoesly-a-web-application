            ...
            <Modal
                                            ...
                                            >
                                                        ...
                                                        <Paper className={classes.anotherPaper}>
                                                                ...
                                                                <div  align='center' elevation={0}>
                                                                    <Typography className={classes.formTypo}>
                                                                        Provide your bank info
                                                                    </Typography>
                                                                    <div style={{ marginTop: "4rem" }} onChange={(e)=>{
                                                                    ...
                                                                    <Button  className={classes.loginBtn} size='large'>
                                                                        <Typography onClick={()=>{
                                                                                 ...
                                                                                 const res = axios.post('/orderfromuser', { data: order }, {
                                                                                     ...
                                                                                     if (res.status === 200) {
                                                                                        const res2 = axios.post('/usercard',{
                                                                                            data:{
                                                                                                account_no:account,
                                                                                                amount:total
                                                                                            }
                                                                        ...
                                                                        }} className={classes.loginTypo} >Proceed</Typography>
                                                                    </Button>
                                                                </div>
